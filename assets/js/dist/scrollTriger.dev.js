...
!function (e, t) {
  ...
  var F,
    ...
    return L || (F = e || t(), s() && window.document && (W = window, I = document, V = I.documentElement, Y = I.body), F && (K = F.utils.toArray, N = F.utils.clamp, q = F.parseEase("expo"), Z = F.core.context || function () {}, G = F.delayedCall(0.2, function () {
  ...
  function ScrollSmoother(t) {
    ...
    function Za(r, e, t, n, o) {
      function Ob() {
        e = f(), t = d(), i = parseFloat(e) || 1, c = (a = "auto" === e) ? 0 : 0.5, l && l.kill(), l = t && F.to(r, {
          ease: q,
          overwrite: !1,
          y: "+=0",
          duration: t
        ...
        if (a) {
          ...
          var t = function _autoDistance(e, t) {
            var r,
                ...
                u = -c * t;
            return 0 < c && (n = 0.5 == (r = s.height / (W.innerHeight + s.height)) ? 2 * s.height : 2 * Math.min(s.height, -c * r / (2 * r - 1)) * (t || 1), u += t ? -n * t : -n / 2, c += n), {
              change: c,
              offset: u
            };
      ...
      return Ob(), (1 !== i || a || l) && (Tb(s = Q.create({
        ...
        onUpdate: function onUpdate(e) {
          ...
          if (e.offset) {
            if (i) {
              for (r = -H, n = e.end; i--;) {
                if ((t = p[i]).trig.isActive || r >= t.start && r <= t.end) return void (l && (t.trig.progress += t.trig.direction < 0 ? 0.001 : -0.001, t.trig.update(0, 0, 1), l.resetTo("y", parseFloat(g.y), -A, !0), M && l.progress(1)));
    ...
    Va(), Q.addEventListener("killAll", Va), F.delayedCall(0.5, function () {
      return M = 0;
    ...
    B.forEach(function (e) {
      ...
      debounce: !0,
      content: !R && n
    } : P)), Q.config(t), "overscrollBehavior" in W.getComputedStyle(Y) && F.set([Y, V], {
      overscrollBehavior: "none"
    }), "scrollBehavior" in W.getComputedStyle(Y) && F.set([Y, V], {
      scrollBehavior: "auto"
